...
<!-- Featured Start -->
    ...
    <!-- Offer Start -->
    <div class="container-fluid offer pt-5 d-none">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <a href="/product/{{$v->slug}}"> <img class="img-fluid w-100" width="281px" height="281px" src="{{ img_url($v->image_one) }}" alt="{{$v->product_name}}"> </a>
                    </div>
