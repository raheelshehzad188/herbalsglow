                    ...
                    <form class="form-horizontal" id="product_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group"><label class="col-sm-12 control-label">Product Type:</label>
                                    <div class="col-sm-12"><input type="text"  class="form-control" value="<?php echo isset($edit->ptype) ? htmlspecialchars($edit->ptype) : null; ?>" name="ptype"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                             ...
                             <div class="col-sm-4">
                                <div class="form-group"><label class="col-sm-12 control-label">Product Specification:</label>
                                    <div class="col-sm-12"><input type="text" data-role="tagsinput" class="form-control" value="<?php echo isset($edit->specification) ? htmlspecialchars($edit->specification) : null; ?>" name="specification" ></div>
                                </div>
                            </div>
                            <div class="col-sm-4">
